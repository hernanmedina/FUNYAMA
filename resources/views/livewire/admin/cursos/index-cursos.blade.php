                        ...
                        @foreach($cursos as $curso)
                            <tr class="hover:bg-gray-50">
                                <td class="px-4 py-4 whitespace-nowrap">
                                    <input type="checkbox" wire:model.live="selected" value="{{ $curso->codigo }}" class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                                </td>
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <div class="mt-3 flex items-center justify-between">
                                        ...
                                        <div class="flex items-center space-x-3">
                                            <a href="{{ route('admin.cursos.show', $curso->codigo) }}" class="text-blue-600">
                                            ...
                                            <a href="{{ route('admin.cursos.edit', $curso->codigo) }}" class="text-green-600">
