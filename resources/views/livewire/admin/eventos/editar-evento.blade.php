<div>
    <div class="container mx-auto py-6 px-4">
        <div class="mb-6">
            ...
            <h1 class="text-3xl font-bold text-gray-800 mt-2">Editar Evento</h1>
        </div>

        <form wire:submit="actualizarEvento" class="bg-white rounded-lg shadow p-6 max-w-4xl">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <!-- Inscritos Actuales (solo lectura) -->
                <div>
                    <label for="inscritos_actual" class="block text-sm font-medium text-gray-700 mb-2">
                        Inscritos Actuales
                    </label>
                    <input wire:model="inscritos_actual" type="number" id="inscritos_actual" readonly
                ...
                <div class="md:col-span-2">
                    ...
                    @if($imagen_actual)
                        <div class="mb-3">
                            ...
                            <img src="{{ asset('storage/' . $imagen_actual) }}" alt="Evento" class="h-32 w-auto rounded-lg">
                        </div>
                    @endif
                    ...
                    @if($imagen)
                        <p class="text-sm text-green-600 mt-2">Nueva imagen cargada</p>
                    @endif
                </div>
