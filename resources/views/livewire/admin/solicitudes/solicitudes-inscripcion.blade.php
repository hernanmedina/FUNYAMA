    ...
    <div class="container mx-auto py-6 px-4">
        ...
        <div class="flex justify-between items-center mb-6">
            <div>
                ...
                <p class="text-gray-600 mt-1">Gestiona las solicitudes de inscripción a cursos e inscripciones a eventos</p>
            </div>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Curso / Evento</th>
                        ...
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="flex-shrink-0 h-10 w-10 {{ $item['tipo'] === 'evento' ? 'bg-purple-100' : 'bg-blue-100' }} rounded-full flex items-center justify-center">
                                        <span class="{{ $item['tipo'] === 'evento' ? 'text-purple-600' : 'text-blue-600' }} font-medium">
                                            {{ substr($item['nombre'] ?: $item['email'], 0, 1) }}
                                        </span>
                                    </div>
                                    <div class="ml-4">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                @if($item['tipo'] === 'evento')
                                    <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-purple-100 text-purple-800">Evento</span>
                                @else
                                    <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-blue-100 text-blue-800">Curso</span>
                                @endif
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900">{{ $item['detalle'] }}</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                @php
                                    $estadoColors = [
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                ...
                                @elseif($item['estado'] === 'pendiente' || $item['estado'] === 'en_proceso')
                                    <button wire:click="abrirModalRevision({{ $item['id'] }})"
                                            class="text-blue-600 hover:text-blue-900 mr-3">
                                        Revisar
                                    </button>
                                    @if($item['estado'] === 'pendiente')
                                        <button wire:click="marcarEnProceso({{ $item['id'] }})"
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-6 py-10 text-center text-gray-500">
                                ...
                                <p class="mt-1">Cuando los visitantes soliciten inscripción a cursos o eventos, aparecerán aquí.</p>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
