            ...
            <div class="bg-white rounded-lg shadow">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                        ...
                        <a href="{{ route('admin.solicitudes.inscripcion') }}"
                           class="bg-teal-600 hover:bg-teal-700 text-white p-3 rounded-lg flex flex-col items-center justify-center text-center transition-colors h-24">
                            <svg class="w-6 h-6 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
