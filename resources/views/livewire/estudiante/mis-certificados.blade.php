        ...
        @forelse($certificados as $cert)
            <div class="bg-white rounded-lg shadow hover:shadow-lg transition-shadow p-6">
                ...
                <div class="grid grid-cols-2 gap-2">
                    <a href="{{ Storage::url($cert->archivo_path) }}"
                       target="_blank"
                       class="w-full bg-gray-100 hover:bg-gray-200 text-gray-800 py-2 rounded transition-colors flex items-center justify-center text-sm font-medium">
                    ...
                    <button wire:click="descargarCertificado({{ $cert->id }})"
                            class="w-full bg-blue-600 hover:bg-blue-700 text-white py-2 rounded transition-colors flex items-center justify-center text-sm font-medium">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
